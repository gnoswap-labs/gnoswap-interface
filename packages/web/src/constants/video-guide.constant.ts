...
export const YOUTUBE_LINKS = {
  [VIDEO_GUIDE_TYPES.POSITION]: "hZTuS5CyanQ",
  [VIDEO_GUIDE_TYPES.STAKING]: "xvPEuIqwSx0",
  [VIDEO_GUIDE_TYPES.GOVERNANCE]: "x4XTWkrlB9s",
  [VIDEO_GUIDE_TYPES.LEADERBOARD]: "WV4Aj8RGh50",
  [VIDEO_GUIDE_TYPES.LAUNCHPAD]: "qO6RykuFS-o",
};
