...
export const PACKAGE_POOL_PATH = process.env.NEXT_PUBLIC_PACKAGE_POOL_PATH || "";
export const PACKAGE_POOL_ADDRESS = getAddressByPackagePath(PACKAGE_POOL_PATH);

export const PACKAGE_POSITION_PATH = process.env.NEXT_PUBLIC_PACKAGE_POSITION_PATH || "";
...
export const PACKAGE_GOVERNANCE_STAKER_ADDRESS = getAddressByPackagePath(PACKAGE_GOVERNANCE_STAKER_PATH);

export const PACKAGE_LAUNCHPAD_PATH = process.env.NEXT_PUBLIC_PACKAGE_LAUNCHPAD_PATH || "";

export const PACKAGE_LAUNCHPAD_ADDRESS = getAddressByPackagePath(PACKAGE_LAUNCHPAD_PATH);
...
export const SOCIAL_WALLET_AUTH_CLIENT_ID = process.env.NEXT_PUBLIC_SOCIAL_WALLET_AUTH_CLIENT_ID || "";
export const SOCIAL_WALLET_GOOGLE_CLIENT_ID = process.env.NEXT_PUBLIC_SOCIAL_WALLET_GOOGLE_CLIENT_ID || "";
export const SOCIAL_WALLET_AUTH_DOMAIN = process.env.NEXT_PUBLIC_SOCIAL_WALLET_AUTH_DOMAIN || "";
export const SOCIAL_WALLET_GOOGLE_VERIFIER = process.env.NEXT_PUBLIC_SOCIAL_WALLET_GOOGLE_VERIFIER || "";
export const SOCIAL_WALLET_TWITTER_VERIFIER = process.env.NEXT_PUBLIC_SOCIAL_WALLET_TWITTER_VERIFIER || "";
export const SOCIAL_WALLET_EMAIL_VERIFIER = process.env.NEXT_PUBLIC_SOCIAL_WALLET_EMAIL_VERIFIER || "";
