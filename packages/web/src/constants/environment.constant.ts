const ENV_VARIABLES = {
  ...
  PACKAGE_GOVERNANCE_PATH: process.env.NEXT_PUBLIC_PACKAGE_GOVERNANCE_PATH || "",
...
export const PACKAGE_GOVERNANCE_PATH = currentEnvVariables.PACKAGE_GOVERNANCE_PATH;
