...
describe("get notifications by address", () => {
  it("success", async () => {
    ...
    const notification = await accountNotificationRepository.getNotificationsByAddress(address);
  ...
  it("empty storage value is default", async () => {
    ...
    const response = await accountNotificationRepository.getNotificationsByAddress(address);
...
describe("create notifications", () => {
  it("success", async () => {
    ...
    const resposne = await accountNotificationRepository.createNotification(address, data);
    const afterNotification = await accountNotificationRepository.getNotificationsByAddress(address);
...
describe("create notifications", () => {
  it("success", async () => {
    ...
    const beforeNotification = await accountNotificationRepository.getNotificationsByAddress(address);
    await accountNotificationRepository.updateNotificationStatus(address, data.txHash, "SUCCESS");
    const afterNotification = await accountNotificationRepository.getNotificationsByAddress(address);
  ...
  it("not matched transaction is not changed", async () => {
    ...
    await accountNotificationRepository.createNotification(address, data);
    const beforeNotification = await accountNotificationRepository.getNotificationsByAddress(address);
    await accountNotificationRepository.updateNotificationStatus(address, "XXX", "SUCCESS");
    const afterNotification = await accountNotificationRepository.getNotificationsByAddress(address);
