...
import { DashboardTokenResponse, GovernanceOverviewResponse, IVolumeResponse, TvlResponse } from "./response";
...
export interface DashboardRepository {
  ...
  getDashboardOnchainActivity: (req: OnchainRequest) => Promise<ActivityResponse>;
  getAccountOnchainActivity: (req: OnchainAccountRequest) => Promise<ActivityResponse>;
}
