...
const PoolAddConfirmAmountInfo: React.FC<EarnAddConfirmAmountInfoProps> = ({ tokenA, tokenB, feeRate }) => {
  ...
  return (
    <PoolAddConfirmAmountInfoWrapper>
      ...
      <PoolAddConfirmFeeInfoSection>
        <span className="key">{t("AddPosition:confirmAddModal.info.label.feeTier")}</span>
        <Badge text={feeRate} type={BADGE_TYPE.DARK_DEFAULT} className="value" />
      </PoolAddConfirmFeeInfoSection>
    </PoolAddConfirmAmountInfoWrapper>
  );
};
