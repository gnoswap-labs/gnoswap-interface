...
export function getLiquidityForAmount0(sqrtRatioAX96: bigint, sqrtRatioBX96: bigint, amount0: bigint): bigint {
  ...
  return (amount0 * intermediate) / (currentSqrtRatioBX96 - currentSqrtRatioAX96);
}
...
export function getLiquidityForAmounts(
  ...
  if (sqrtRatioX96 <= currentSqrtRatioAX96) {
    liquidity = getLiquidityForAmount0(currentSqrtRatioAX96, currentSqrtRatioBX96, amount0);
  } else if (sqrtRatioX96 < currentSqrtRatioBX96) {
    const liquidity0 = getLiquidityForAmount0(sqrtRatioX96, currentSqrtRatioBX96, amount0);
    const liquidity1 = getLiquidityForAmount1(currentSqrtRatioAX96, sqrtRatioX96, amount1);
    ...
    liquidity = getLiquidityForAmount1(currentSqrtRatioAX96, currentSqrtRatioBX96, amount1);
  }
...
export function getAmount0ForLiquidity(sqrtRatioAX96: bigint, sqrtRatioBX96: bigint, liquidity: bigint): bigint {
  ...
  return (
    ((liquidity << 96n) * (currentSqrtRatioBX96 - currentSqrtRatioAX96)) / currentSqrtRatioBX96 / currentSqrtRatioAX96
  );
}
...
export function getAmountsForLiquidity(
  ...
  if (sqrtRatioX96 <= currentSqrtRatioAX96) {
    amount0 = getAmount0ForLiquidity(currentSqrtRatioAX96, currentSqrtRatioBX96, liquidity);
  } else if (sqrtRatioX96 < currentSqrtRatioBX96) {
    amount0 = getAmount0ForLiquidity(sqrtRatioX96, currentSqrtRatioBX96, liquidity);
    amount1 = getAmount1ForLiquidity(currentSqrtRatioAX96, sqrtRatioX96, liquidity);
  } else {
    amount1 = getAmount1ForLiquidity(currentSqrtRatioAX96, currentSqrtRatioBX96, liquidity);
  }
