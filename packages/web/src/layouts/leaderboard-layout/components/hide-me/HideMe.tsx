    ...
    <Flex>
      <Hover>
        <Tooltip
          ...
          FloatingContent={
            <TooltipContent>
              Your username or address will be hidden. Other users will not be able to see your positions.
            </TooltipContent>
          }
        >
          <StyledIconInfo />
      ...
      <FontSize16>{isMobile ? "Hide me" : "Hide my address or username"}</FontSize16>
    </Flex>
  );
};
