    ...
    <ProposalDetailWrapper>
      ...
      <ProgressWrapper>
        <ProgressBar
          ...
          noOfQuorumWidth={proposalDetail.noOfQuorum}
        >
          <Tooltip
            floatClassName="float-progress"
            placement="top"
            FloatingContent={`Yes ${proposalDetail.yesOfQuorum}`}
          >
          ...
          <Tooltip
            floatClassName="float-progress"
            placement="top"
            FloatingContent={`No ${proposalDetail.noOfQuorum}`}
          >
          ...
          <Tooltip
            floatClassName="float-progress"
            placement="top"
            FloatingContent={`Abstain ${proposalDetail.abstainOfQuorum}`}
          >
