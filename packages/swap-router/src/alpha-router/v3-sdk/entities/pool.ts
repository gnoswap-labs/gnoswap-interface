...
export class Pool {
  ...
  public readonly tvlUSD: number;
  public readonly tvlGNOT: number;
  ...
  public constructor(
    ...
    this.tvlUSD = Number(liquidity.toString());
    this.tvlGNOT = Number(liquidity.toString());
    this.path = `${this.token0.address}:${
      this.token1.address
    }:${this.fee.toString()}`;
  }
