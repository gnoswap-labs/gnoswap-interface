import { CurrencyAmount, Fraction, TradeType } from "../core";
import { RouteWithValidQuote } from "../entities";
import { SwapOptions, SwapOptionsUniversalRouter, SwapType } from "../router";
    ...
    switch (tradeType) {
      case TradeType.EXACT_INPUT:
        if (
          ...
          swapConfigUniversalRouter.fee.fee.greaterThan(0)
        ) {
      ...
      case TradeType.EXACT_OUTPUT:
        if (
          ...
          swapConfigUniversalRouter.flatFee.amount > 0
        ) {
