...
exports.sqrtPriceX96ToTick = exports.nextInitializedTickWithinOneWord = exports.tickToSqrtPriceX96 = exports.tickToPrice = void 0;
const bignumber_js_1 = __importDefault(require("bignumber.js"));
const constants_1 = require("../../constants");
const math_util_1 = require("./math.util");
function tickToPrice(tick) {
    const sqrtPriceX96 = tickToSqrtPriceX96(tick);
    return (0, bignumber_js_1.default)(sqrtPriceX96.toString())
        .dividedBy(constants_1.Q96.toString())
        .toNumber();
}
...
function tickToSqrtPriceX96(tick) {
    ...
    if (tick > 0) {
        ratio = constants_1.MAX_UINT256 / ratio;
    }
...
function nextInitializedTickWithinOneWord(tickBitmaps, tick, tickSpacing, isTickToLeft) {
    ...
    if (isTickToLeft) {
        ...
        const tickNext = initialized
            ? (compressed - bitPos + Number((0, math_util_1.MSB)(masked))) * tickSpacing
    ...
    const tickNext = initialized
        ? (nextCompressed + (Number((0, math_util_1.LSB)(masked)) - bitPos)) * tickSpacing
        : (nextCompressed +
            (0, bignumber_js_1.default)(constants_1.MAX_UINT8.toString()).minus(bitPos).toNumber()) *
            tickSpacing;
    return {
        tickNext,
        initialized,
...
function tickBitmapPosition(tick) {
...
exports.sqrtPriceX96ToTick = sqrtPriceX96ToTick;
function gt(x, y) {
    return x > y ? 1n : 0n;
}
