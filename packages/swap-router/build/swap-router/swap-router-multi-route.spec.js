...
describe("swap router of multi pair pools", () => {
    describe("gno.land/r/bar to gno.land/r/qux", () => {
        test("EXANCT_IN, 100000", async () => {
            ...
            const estimatedRoutes = swapRouter.estimateSwapRoute("gno.land/r/bar", "gno.land/r/foo", 100000n, "EXACT_IN");
            const sumAmount = (0, array_util_1.sumBigInts)(estimatedRoutes.map(route => route.amountOut));
            expect(estimatedRoutes).toHaveLength(2);
            expect(estimatedRoutes[0].routeKey).toBe("gno.land/r/bar:gno.land/r/qux:500*POOL*gno.land/r/baz:gno.land/r/qux:500*POOL*gno.land/r/baz:gno.land/r/foo:500");
            expect(estimatedRoutes[0].quote).toBe(95);
            expect(estimatedRoutes[1].routeKey).toBe("gno.land/r/bar:gno.land/r/foo:100");
    ...
    describe("gno.land/r/qux to gno.land/r/bar", () => {
        test("EXANCT_IN, 100000", async () => {
            ...
            const sumAmount = (0, array_util_1.sumBigInts)(estimatedRoutes.map(route => route.amountOut));
            expect(estimatedRoutes).toHaveLength(1);
            expect(estimatedRoutes[0].routeKey).toBe("gno.land/r/bar:gno.land/r/qux:100");
            expect(estimatedRoutes[0].quote).toBe(100);
